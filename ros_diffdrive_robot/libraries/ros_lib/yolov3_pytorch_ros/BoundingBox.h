#ifndef _ROS_yolov3_pytorch_ros_BoundingBox_h
#define _ROS_yolov3_pytorch_ros_BoundingBox_h
...
namespace yolov3_pytorch_ros
{
  ...
  class BoundingBox : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "yolov3_pytorch_ros/BoundingBox"; };
