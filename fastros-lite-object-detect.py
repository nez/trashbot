...
detector.setModelPath( os.path.join(execution_path , "/home/nex/ML-notebooks/ImageAI/yolov3.pt"))
detector.loadModel()
def detect(img):
    return detector.detectObjectsFromImage(img, minimum_percentage_probability=30)
